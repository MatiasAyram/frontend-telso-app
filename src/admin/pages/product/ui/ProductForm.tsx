              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-medium mb-2">
                    <p
                      className={`${
                        errors.title ? "text-red-500" : "text-slate-700"
                      }`}
                    >
                      {errors.title
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">
                      <p
                        className={`${
                          errors.price ? "text-red-500" : "text-slate-700"
                        }`}
                      >
                        {errors.price ? "El precio es requerido" : "Precio $"}
                      </p>
                    </label>
                    <input
                      type="number"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-slate-700 mb-2">
                      <p
                        className={`${
                          errors.stock ? "text-red-500" : "text-slate-700"
                        }`}
                      >
                        {errors.stock
                ...
                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">
                    <p
                      className={`${
                        errors.slug ? "text-red-500" : "text-slate-700"
                      }`}
                    >
                      {errors.slug?.message
                        ? errors.slug?.message
                        : errors.slug
                        ? "El slog es requerido"
                        : "Slug del producto"}
                    </p>
                  </label>
                  <input
                ...
                <div className="mt-6 space-y-3">
                  {files.length === 0 ? (
                    <p className="text-gray-400 font-light text-center">
                      No se ha cargado ningún archivo nuevo
                    </p>
                  ) : (
                    <>
                      <h3 className="text-sm font-medium text-slate-700">
